...
h = os.path.isfile("../../../basis of python/handle file/b.txt")
print("判断path所对应是否为已存在的文件，返回True或False:{}".format(h))

g = os.path.exists("../../../basis of python/handle file/b.txt")
print("判断path对应文件或目录是否存在，返回True或False:{}".format(g))

# 获取文件基本信息
k = os.path.getsize("../../../basis of python/handle file/b.txt")
print("返回path对应文件的大小:{}k".format(k))

a = os.path.abspath("../../../basis of python/handle file/b.txt")
...
l = time.ctime(os.path.getctime("../../../basis of python/handle file/b.txt"))
print("返回path对应文件或目录上一次访问的时间:{}".format(l))

m = time.ctime(os.path.getatime("../../../basis of python/handle file/b.txt"))
print("返回path对应文件或目录最近一次修改的时间:{}".format(m))

n = time.ctime(os.path.getmtime("../../../basis of python/handle file/b.txt"))
print("返回path对应文件或目录的创建时间:{}".format(n))

# 对路径的操作
path = os.path.abspath("../../../basis of python/handle file/b.txt")
